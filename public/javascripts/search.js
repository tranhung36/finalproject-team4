...
const loadValue = async () => {
    try {
        // call api
        const searchJsonValue = await fetch(`https://secret-depths-62399.herokuapp.com/search/searchValue`)
...
const loadSearchValue = async (key) => {
    const searchValue = await fetch(`https://secret-depths-62399.herokuapp.com/search/searchApi?key=${key}`)
